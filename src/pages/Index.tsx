    ...
    <CustomerLayout>
      ...
      {searchQuery ? (
        ...
        <>
          ...
          {nowShowingMovies.length === 0 && comingSoonMovies.length === 0 && movies.length > 0 && (
          ...
          {movies.length === 0 && (
            <div className="container mx-auto px-4 py-20 text-center">
              <h2 className="text-xl font-semibold text-foreground mb-2">No movies available</h2>
          ...
          <footer className="py-12 border-t border-border bg-cinema-dark">
            <div className="container mx-auto px-4">
              ...
              <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
                © 2025 CineBook. All rights reserved by Group 10 HCMUS.
              </div>
            </div>
          </footer>
        </>
